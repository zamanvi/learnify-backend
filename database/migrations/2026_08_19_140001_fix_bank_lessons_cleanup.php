...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $words1 = [
            ['Bank', 'ব্যাংক', 'Banking', 'financial institution'],
            ['Banking', 'ব্যাংকিং', 'Banking', 'bank activities'],
            ['Banker', 'ব্যাংকার', 'Banking', 'bank official'],
            ['Account', 'হিসাব', 'Banking', 'customer record'],
            ['Savings', 'সঞ্চয়', 'Banking', 'money saved'],
            ['Deposit', 'জমা', 'Banking', 'money placed'],
            ['Withdrawal', 'উত্তোলন', 'Banking', 'money taken out'],
            ['Balance', 'ভারসাম্য', 'Banking', 'account total'],
            ['Credit', 'জমা', 'Banking', 'money added'],
            ['Debit', 'উত্তোলন', 'Banking', 'money removed'],
            ['Transaction', 'লেনদেন', 'Banking', 'financial action'],
            ['Payment', 'পেমেন্ট', 'Banking', 'money transfer'],
            ['Cheque', 'চেক', 'Banking', 'payment order'],
            ['Draft', 'ড্রাফট', 'Banking', 'bank order'],
            ['Money order', 'মানি অর্ডার', 'Banking', 'payment method'],
            ['Transfer', 'স্থানান্তর', 'Banking', 'move funds'],
            ['Interest', 'সুদ', 'Banking', 'charge on money'],
            ['Loan', 'ঋণ', 'Banking', 'borrowed money'],
            ['Mortgage', 'বন্ধকী', 'Banking', 'property loan'],
            ['Overdraft', 'ওভারড্রাফট', 'Banking', 'exceed balance'],
            ['Principal', 'মূলধন', 'Banking', 'main amount'],
            ['Compound', 'যৌগিক', 'Banking', 'interest on interest'],
            ['Simple', 'সরল', 'Banking', 'basic interest'],
            ['Rate', 'হার', 'Banking', 'percentage'],
            ['Percentage', 'শতাংশ', 'Banking', 'per hundred'],
            ['Maturity', 'পরিপক্বতা', 'Banking', 'due date'],
            ['Due', 'পাওনা', 'Banking', 'owed'],
            ['Default', 'ডিফল্ট', 'Banking', 'failure to pay'],
            ['Collateral', 'জামানত', 'Banking', 'security'],
            ['Guarantee', 'গ্যারান্টি', 'Banking', 'assurance'],
            ['Surety', 'জামানতদার', 'Banking', 'guarantor'],
            ['Commission', 'কমিশন', 'Banking', 'fee'],
            ['Charge', 'চার্জ', 'Banking', 'cost'],
            ['Fee', 'ফি', 'Banking', 'payment'],
            ['Penalty', 'জরিমানা', 'Banking', 'fine'],
        ];
