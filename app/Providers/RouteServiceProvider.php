...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->routes(function () {
            ...
            Route::prefix('api/v2')->middleware('api')->namespace($this->namespace . '\Api\v2')->group(base_path('routes/api/wizard.php'));
            Route::prefix('api/v2')->middleware('api')->namespace($this->namespace . '\Api\v2')->group(base_path('routes/api/websection.php'));
