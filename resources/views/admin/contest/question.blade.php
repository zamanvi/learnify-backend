                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Create Question for {{ '"' . $contest->name . '"' }}</h4>
                        </div>
                    </div>
                    <div class="iq-card-body">
                        <form method="POST" action="{{ route('contest.question.store') }}">
                            @csrf
                            <div class="form-group">
                                <label for="contest_id">Contest Name</label>
                                <input type="text" readonly class="form-control" id="contest_id"
                                    value="{{ $contest->name }}">
                                <input name="contest_id" hidden value="{{ $contest->id }}">
                            </div>
                            <div class="form-group">
