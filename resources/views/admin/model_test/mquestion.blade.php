        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <form method="POST" action="{{ route('mquestion.store') }}">
                            @csrf
                            <div class="form-group">
                                <label for="modeltest_id">Model Test</label>
                                <input type="text" readonly class="form-control" id="modeltest_id" value="{{ $modeltest->name }}">
                                <input hidden name="modeltest_id" class="form-control"
                                    value="{{ $modeltest->id }}">
                            </div>
                            <div class="form-group">
