                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('item.show', $bookItem->slug) }}"><i
                                                                class="ri-eye-fill mr-2"></i>Show</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('item.notification', $bookItem->slug) }}"><i
                                                                class="ri-eye-fill mr-2"></i>Send Notification</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('item.edit', $bookItem->slug) }}"><i
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('item.store') }}">
                                    ...
                                    <div class="tab-content" id="pills-tabContent-2">
                                        <div class="tab-pane fade show active" id="short_details" role="tabpanel"
                                            ...
                                            <input required type="text" name="short_details" class="form-control"
                                                id="short_details" placeholder="Post Short Details">
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="audio_text" class="form-control" cols="10" id="audio_text"> </textarea>
                            </div>
                            <div class="form-group">
                                <label for="details">Post Details</label>
                                <textarea class="form-control" name="details" id="editor1" rows="5"></textarea>
                            </div>
                            <div class="form-group">
