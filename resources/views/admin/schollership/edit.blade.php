                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Edit scholarShip</h4>
                        </div>
                        <div class="iq-header-title">
                            <h4 class="card-title"> <a href="{{ route('scholarship.create') }}">Create</a></h4>
                        </div>
                    </div>
                        ...
                        <form method="POST" action="{{ route('scholarship.update', $scholarShip->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" required name="enroll_limit" class="form-control" id="enroll_limit"
                                    value="{{ $scholarShip->enroll_limit }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" required name="winner_limit" class="form-control" id="winner_limit"
                                    value="{{ $scholarShip->winner_limit }}">
                            </div>
                            <div class="form-group">
                                <label for="date">Select Date</label>
                                <input type="date" required name="date" value="{{ $scholarShip->date }}" class="form-control" id="date">
                            </div>
                            <div class="form-group">
                                <label for="time">Set Time</label>
                                <input type="time" required name="time" value="{{ $scholarShip->time }}" class="form-control" id="time">
                            </div>
                            <div class="form-group">
                                <label for="short_description">Scholarship Short Description</label>
                                <textarea class="form-control" name="short_description" id="short_description" rows="5">{{ $scholarShip->short_description }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="editor1">Scholarship Description</label>
                                <textarea class="form-control" name="description" id="editor1" rows="5">{{ $scholarShip->description }}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="sponsor" class="form-control" id="sponsor" value="{{ $scholarShip->sponsor }}">
                            </div>
                            <div class="form-group">
                                <label for="sponsor_image_path">Scholarship Sponsor Banner Image</label>
                                <input name="sponsor_image_path" type="file" accept="image/*" class="form-control-file" id="sponsor_image_path">
                                <img src="{{ $scholarShip->sponsor_image }}" alt="">
                            </div>
                            <div class="">
